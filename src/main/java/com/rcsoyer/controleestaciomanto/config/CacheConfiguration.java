package com.rcsoyer.controleestaciomanto.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.rcsoyer.controleestaciomanto.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.rcsoyer.controleestaciomanto.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
