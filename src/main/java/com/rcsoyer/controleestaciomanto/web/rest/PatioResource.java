...
public class PatioResource {
     ...
     * @return the ResponseEntity with status 201 (Created) and with body the new patioDTO, or with status 400 (Bad Request) if the patio has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/patios")
    @Timed
    public ResponseEntity<PatioDTO> createPatio(@Valid @RequestBody PatioDTO patioDTO) throws URISyntaxException {
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the updated patioDTO,
     * or with status 400 (Bad Request) if the patioDTO is not valid,
     * or with status 500 (Internal Server Error) if the patioDTO couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/patios")
    @Timed
    public ResponseEntity<PatioDTO> updatePatio(@Valid @RequestBody PatioDTO patioDTO) throws URISyntaxException {
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the patioDTO, or with status 404 (Not Found)
     */
