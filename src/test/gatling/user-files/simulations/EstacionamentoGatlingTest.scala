...
/**
 * Performance test for the Estacionamento entity.
 */
class EstacionamentoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Estacionamento entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all estacionamentos")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created estacionamento")
                .get("${new_estacionamento_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created estacionamento")
            .delete("${new_estacionamento_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
